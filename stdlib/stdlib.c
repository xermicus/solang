...
POLKAVM_IMPORT(void, input, 13, size_t, size_t);
POLKAVM_IMPORT(void, seal_return, 14, size_t, size_t, size_t);
POLKAVM_IMPORT(void, value_transferred, 27, size_t, size_t);

extern void __solang_trap() {
    POLKAVM_TRAP();
}
